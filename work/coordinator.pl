...
path(var_Start,var_End,var_TotalDistance,var_Visited,var_Path):-connected(var_Start,var_Intermediate,var_Distance1),\+member(var_Intermediate,var_Visited),append([var_Intermediate],var_Visited,var_NewList),path(var_Intermediate,var_End,var_Distance2,var_NewList,var_Path),var_TotalDistance is var_Distance1+var_Distance2.
...
eve(driver_location(var_Driver,var_Location)):-(driver_at(var_Driver,var_OtherLocation)->retract(driver_at(var_Driver,var_OtherLocation));true),assert(driver_at(var_Driver,var_Location)),(delivery_busy(var_Driver)->retract(delivery_busy(var_Driver)),true),format('~w is now located at ~w~n',[var_Driver,var_Location]).
...
make_delivery(var_Destination,var_Resource,var_Quantity):-available_driver_at(var_Driver,var_DriverLocation),find_warehouse(var_Resource,var_Quantity,var_Warehouse),find_path(var_DriverLocation,var_Warehouse,var_Distance1,var_Path1),find_path(var_Warehouse,var_Destination,var_Distance2,var_Path2),var_TotalDistance is var_Distance1+var_Distance2,a(message(var_Driver,send_message(new_delivery(var_Destination,var_Warehouse,var_Resource,var_Quantity),var_Me))),format('Assigned ~w going from ~w to ~w for a distance of ~w~n~n',[var_Driver,var_Warehouse,var_Destination,var_TotalDistance]).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_544709,var_Ontology,_544713),_544703),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_544747)),a(message(var_Ag,propose(var_A,[_544747],var_AgI))),retractall(ext_agent(var_Ag,_544785,var_Ontology,_544789)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_544583,var_Ontology,_544587),_544577),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_544653,var_Ontology,_544657)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_544471,var_Ontology,_544475),_544465),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_544527,var_Ontology,_544531)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_544035),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_544069),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_543851).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_543699),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_543647),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_543523,_543525)),clause(agente(_543545,_543547,_543549,var_S),_543541),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_543317,_543319,_543321,var_S),_543313),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_543417,[]),repeat,read(_543417,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_543417).
