...
eve(new_delivery(var_Location,var_Resource,var_Quantity)):- \+state(busy),format('Accepted delivery for ~w ~w to ~w~n',[var_Quantity,var_Resource,var_Location]),a(message(coordinator,send_message(driver_accepts(var_Me,var_Location,var_Resource,var_Quantity),var_Me))),assert(busy).

eve(new_delivery(var_Location,var_Resource,var_Quantity)):-state(busy),format('Refusing delivery for ~w ~w to ~w~n',[var_Quantity,var_Resource,var_Location]),a(message(coordinator,send_message(driver_busy(var_Me,var_Location,var_Resource,var_Quantity),var_Me))).
...
call_cfp(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_345077,var_Ontology,_345081),_345071),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_cfp(var_A,var_C,var_Ag,_345115)),a(message(var_Ag,propose(var_A,[_345115],var_AgI))),retractall(ext_agent(var_Ag,_345153,var_Ontology,_345157)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_344951,var_Ontology,_344955),_344945),asserisci_ontologia(var_Ag,var_Ontology,var_A),once(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,accept_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_345021,var_Ontology,_345025)).

call_propose(var_A,var_C,var_Ag):-clause(agent(var_AgI),var__),clause(ext_agent(var_Ag,_344839,var_Ontology,_344843),_344833),not(call_meta_execute_propose(var_A,var_C,var_Ag)),a(message(var_Ag,reject_proposal(var_A,[],var_AgI))),retractall(ext_agent(var_Ag,_344895,var_Ontology,_344899)).
...
call_cancel(var_A,var_Ag):-if(clause(high_action(var_A,var_Te,var_Ag),_344403),retractall(high_action(var_A,var_Te,var_Ag)),true),if(clause(normal_action(var_A,var_Te,var_Ag),_344437),retractall(normal_action(var_A,var_Te,var_Ag)),true).
...
refused_message(var_To,var_M):-clause(eliminated_message(var_M,var_To,motivation(conditions_not_verified)),_344219).
...
send_jasper_return_message(var_X,var_S,var_T,var_S0):-clause(agent(var_Ag),_344067),a(message(var_S,send_message(sent_rmi(var_X,var_T,var_S0),var_Ag))).

gest_learn(var_H):-clause(past(learn(var_H),var_T,var_U),_344015),learn_if(var_H,var_T,var_U).

evi(gest_learn(var_H)):-retractall(past(learn(var_H),_343891,_343893)),clause(agente(_343913,_343915,_343917,var_S),_343909),name(var_S,var_N),append(var_L,[46,112,108],var_N),name(var_F,var_L),manage_lg(var_H,var_F),a(learned(var_H)).

cllearn:-clause(agente(_343685,_343687,_343689,var_S),_343681),name(var_S,var_N),append(var_L,[46,112,108],var_N),append(var_L,[46,116,120,116],var_To),name(var_FI,var_To),open(var_FI,read,_343785,[]),repeat,read(_343785,var_T),arg(1,var_T,var_H),write(var_H),nl,var_T==end_of_file,!,close(_343785).
